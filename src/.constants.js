module.exports = Object.freeze({
  TOKEN: '1258199857:AAEFodJDirD8kBchU-bMhamdJq6p_UWr--Y',
  ...
  INDEX_DOMAIN: 'https://thehiddenkia.veis.workers.dev/003/', //Get it from here https://gdindex-code-builder.glitch.me/
  GDRIVE_PARENT_DIR_ID: '18wVfNx6GArBjWYToKAf6OEkfK8PU5Tmb',
  SUDO_USERS: [253131957],	// Telegram user IDs. These users can use the bot in any chat.
  AUTHORIZED_CHATS: [-1001483108436],	// Telegram chat IDs. Anyone in these chats can use the bot.
